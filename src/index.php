						...
						<div class="header_content d-flex flex-row align-items-center justify-content-center">
							...
							<div class="logo">
								<a href="#" class="d-flex flex-row align-items-end justify-content-start">
									...
									<span class="logo_text">LibIT!</span>
								</a>
							</div>
							...
							<div class="log_reg d-flex flex-row align-items-center justify-content-start">
								...
								<!-- Hamburger -->
								<div class="hamburger d-flex flex-column align-items-end justify-content-between">
									<div></div>
									<div></div>
									<div></div>
								</div>
									...
									<div class="col">
										<div class="home_content">
											<div class="home_title_container text-center">
												<div class="home_title islive text-center">
					...
					<div class="col-lg-4 order-lg-1 order-2 musics_col">
						<div class="extra d-flex flex-column align-items-center justify-content-between">
							...
							<div class="extra_title_container">
								...
								<div class="extra_title">TOP MUSIC</div>
								<div class="extra_subtitle">november 2018</div>
							</div>
							<div class="button extra_button"><a href="#">Check</a></div>
						</div>
					</div>
